...
export const Burguna=(props) => {
    ...
    useEffect(()=>{
        fetch('https://sellinbd.com/api330088/product/searchbyPlace.php?place=Burguna&page_number=1&item_count=1000')
        .then(res=>{
            if(res.status===200){
                setSuccess(true)
                res.json()
    ...
    // useEffect(()=>{
    //     fetch('https://sellinbd.com/api330088/product/searchbyItem.php?item=Agricultural Tools and Machinery&page_number=2&item_count=1000')
    //     .then(res=>{
    //         if(res.status===200){
    //             setSuccess(true)
    //             res.json()
