...
export const Patuakhali = (props) => {
    ...
    useEffect(()=>{
        fetch('https://sellinbd.com/api330088/product/searchbyPlace.php?place=Patuakhali&page_number=1&item_count=1000')
        .then(res=>{
            if(res.status===200){
                setSuccess(true)
                res.json()
    ...
    // useEffect(()=>{
    //     fetch('https://sellinbd.com/api330088/product/searchbyPlace.php?place=&page_number=1&item_count=1000')
    //     .then(res=>{
    //         if(res.status===200){
    //             setSuccess(true)
    //             res.json()
