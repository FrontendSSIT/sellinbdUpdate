...
export const WaterTransports = (props) => {
    ...
    useEffect(()=>{
        fetch('https://sellinbd.com/api330088/product/searchbyItem.php?item=Water Transports&page_number=1&item_count=10')
        .then(res=>{
            if(res.status===200){
                setSuccess(true)
                res.json()
    ...
    useEffect(()=>{
        fetch('https://sellinbd.com/api330088/product/searchbyItem.php?item=Water Transports&page_number=2&item_count=10')
        .then(res=>{
            if(res.status===200){
                setSuccess(true)
                res.json()
    ...
    useEffect(()=>{
        fetch('https://sellinbd.com/api330088/product/searchbyItem.php?item=Water Transports&page_number=3&item_count=10')
        .then(res=>{
            if(res.status===200){
                setSuccess(true)
                res.json()
    ...
    useEffect(()=>{
        fetch('https://sellinbd.com/api330088/product/searchbyItem.php?item=Water Transports&page_number=4&item_count=10')
        .then(res=>{
            if(res.status===200){
                setSuccess(true)
                res.json()
