...
export const Refrigerators = (props) => {
    ...
    useEffect(()=>{
        fetch('https://sellinbd.com/api330088/product/searchbyItem.php?item=Refrigerators&page_number=1&item_count=10')
        .then(res=>{
            if(res.status===200){
                setSuccess(true)
                res.json()
    ...
    useEffect(()=>{
        fetch('https://sellinbd.com/api330088/product/searchbyItem.php?item=Refrigerators&page_number=2&item_count=10')
        .then(res=>{
            if(res.status===200){
                setSuccess(true)
                res.json()
    ...
    return (
        <section  className="category">
            ...
            <Row className="justify-content-center" >
                ...
                {
                    products.map(product=><Refrigerator product={product} success={success}/>)
                }
                </Row>
                </Col>
                  </Row>
            ...
            <Row className="justify-content-center" >
                ...
                {
                    products1.map(product=><Refrigerator product={product} success={success}/>)
                }
                </Row>
                </Col>
                  </Row>
            ...
            <Row className="justify-content-center" >
                ...
                {
                    products3.map(product=><Refrigerator product={product} success={success}/>)
                }
                </Row>
                </Col>
                  </Row>
            ...
            <Row className="justify-content-center" >
                ...
                {
                    products4.map(product=><Refrigerator product={product} success={success}/>)
                }
                </Row>
                </Col>
                  </Row>
...
export const Refrigerator = ({product,success}) => {
    return (
