    ...
    return (
        <section  className="category">
            ...
            <Row className="justify-content-center" >
                ...
                {
                    products.map(product=><OthersFurniture product={product} success={success}/>)
                }
                </Row>
                </Col>
                  </Row>
            ...
            <Row className="justify-content-center" >
                ...
                {
                    products1.map(product=><OthersFurniture product={product} success={success}/>)
                }
                </Row>
                </Col>
                  </Row>
            ...
            <Row className="justify-content-center" >
                ...
                {
                    products3.map(product=><OthersFurniture product={product} success={success}/>)
                }
                </Row>
                </Col>
                  </Row>
            ...
            <Row className="justify-content-center" >
                ...
                {
                    products4.map(product=><OthersFurniture product={product} success={success}/>)
                }
                </Row>
                </Col>
                  </Row>
...
export const OthersFurniture = ({product,success}) => {
    return (
